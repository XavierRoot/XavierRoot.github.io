...
window.onscroll = function () {
  var totop = document.getElementById('totop'),
    ...
    changeSize = document.getElementById("header").offsetHeight + document
  ...
  //toc fixed
  scroll >= changeSize ? addClass(fixedToc, "fixed") : removeClass(fixedToc,
    "fixed");
  if (hasClass(fixedToc, "fixed")) {
    fixedToc.style.width = document.getElementById("sidebar").offsetWidth +
      'px';
  }
